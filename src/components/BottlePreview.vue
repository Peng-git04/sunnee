...
const props = defineProps({
  chosen: { type: Array, required: true }, // [capIdx, bodyIdx, bottomIdx]
})

const capColor    = computed(() => COLORS[props.chosen[0]].hex)
const bodyColor   = computed(() => COLORS[props.chosen[1]].hex)
const bottomColor = computed(() => COLORS[props.chosen[2]].hex)
